...
vector<string> IHM::choixDepartArrivee(Metro metro)
{
    ...
    for(int i = 0; i < (int)liste_lignes.size(); ++i){
    ...
    for(int m = 0; m < 2; m++)
    {
        ...
        colorerEcran(14); //jaune
        cout << id_ligne[0];
        for(int i = 1; i < (int)(id_ligne.size()-1); ++i){
            cout << ", " << id_ligne[i];
        }
        ...
        for(int i=0; i < (int)lignes_entree.size(); ++i)
        {
            for(int j=0; j < (int)lignes_entree[i]->getArretsLigne().size(); ++j)
            {
        ...
        for (int i = 0; i < (int)arrets_entree_libelles.size(); ++i)
        {
            colorerEcran(14); //jaune
            cout<< i << " : ";
            colorerEcran(15); //blanc
...
void IHM::afficherItineraire(Itineraire itineraire)
{
    ...
    for(int i=1; i < (int)(it_simplifie.size()-1); ++i){
        colorerEcran(11); //orange
